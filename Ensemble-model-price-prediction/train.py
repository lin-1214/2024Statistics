...
data_in = pd.read_csv('./outputData/BTC_feature.csv')
...
data_out = pd.read_csv('./outputData/BTC_label.csv', parse_dates=['time'])
...
# Execute training
# train_model(model_lstm, train_loader, optimizer,
#             loss_function, epochs=50, name="LSTM")
# train_model(model, train_loader, optimizer,
#             loss_function, epochs=50, name="CNN")
train_model(model_TCN, train_loader, optimizer,
            loss_function, epochs=10, name="TCN")
# train_model(model_stacked, train_loader, optimizer,
#             loss_function, epochs=25, name="Stack")
# train
